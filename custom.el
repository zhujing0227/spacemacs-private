...
(custom-set-variables
 ...
 '(fci-rule-character-color "dim gray")
 ...
 '(org-agenda-finalize-hook
   (defun my:org-agenda-time-grid-spacing nil "Set different line spacing w.r.t. time duration."
          (save-excursion
            (let
                ((colors
